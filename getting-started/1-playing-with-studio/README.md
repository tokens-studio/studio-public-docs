...
You will receive a confirmation email within a few seconds. If you don’t see it in your inbox, please check your spam folder.\
Look for the “Please confirm your registration” email from Tokens Studio. Click the Confirm button or copy and paste the confirmation link into your browser.
{% endstep %}
...
\
If you already have your design tokens set up in Tokens Studio for Figma plugin you can follow the steps in section [Import from Tokens Studio for Figma](import-from-tokens-studio-for-figma.md). \


If you have your design tokens set up as Figma variables follow the steps in the section [Import from Figma variables](import-from-figma-variables.md).\
\
