---
description: >-
  Studio supports managing multiple projects within an organization, allowing
  teams to work on separate design systems or initiatives efficiently.
---

# Projects

This guide walks you through viewing, creating, and managing projects within an organization.
...
{% stepper %}
{% step %}
Click the dropdown at the top of the interface, next to the current project name.
