...
4. Run the graph—your output will be a darker version of the input color.

![Darken Color Example](screenshot-placeholder.png)
...
### See Also
- **Lighten Color**: For making colors lighter instead of darker.
- **Mix Color**: For blending a color with black for more control.
