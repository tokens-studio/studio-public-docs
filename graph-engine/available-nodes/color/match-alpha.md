...
* [**Flatten Alpha**](flatten-alpha.md): For the reverse operation - merging a transparent color with a background.
* [**Contrasting Alpha**](contrasting-alpha.md): For finding alpha values that maintain contrast requirements.
