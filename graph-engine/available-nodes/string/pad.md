...
|-----------|--------------------------------------------|--------|----------|
| string    | The text to pad                            | Text   | Yes      |
| length    | The target length for the padded string    | Number | Yes      |
| character | The character to pad with                  | Text   | Yes      |
| position  | Where to add padding (start or end)        | Text   | No       |

### Outputs
| Name   | Description               | Type |
|--------|---------------------------|------|
| string | The padded text           | Text |

### How to Use It
1. Drag the Pad node into your graph.
2. Connect the text you want to pad to the "string" input.
3. Set the desired "length" for the final string.
...
![Pad Example](screenshot-placeholder.png)
